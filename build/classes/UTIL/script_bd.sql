...
-- -----------------------------------------------------
-- Table `autopecas_barcelos`.`Funcionario`
-- -----------------------------------------------------
...
-- -----------------------------------------------------
-- Table `autopecas_barcelos`.`Entrada`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autopecas_barcelos`.`Entrada` (
  `idEntrada` INT NOT NULL AUTO_INCREMENT,
  `numero_nota` VARCHAR(45) NOT NULL,
  `chave_acesso` VARCHAR(255) NOT NULL,
  `valor_total_nota` VARCHAR(45) NOT NULL,
  `data_entrada` DATETIME NOT NULL,
  `Fornecedor_idFornecedor` INT NOT NULL,
  PRIMARY KEY (`idEntrada`),
  INDEX `fk_Entrada_Fornecedor1_idx` (`Fornecedor_idFornecedor` ) ,
...
-- -----------------------------------------------------
-- Table `autopecas_barcelos`.`item_entrada`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autopecas_barcelos`.`item_entrada` (
  `iditens_entrada` INT NOT NULL AUTO_INCREMENT,
  `quantidade_produto` INT NOT NULL,
  `preco_unitario` VARCHAR(45) NOT NULL,
  `Entrada_idEntrada` INT NOT NULL,
  `Produto_cod_Produto` INT NOT NULL,
  PRIMARY KEY (`iditens_entrada`),
  INDEX `fk_item_entrada_Entrada1_idx` (`Entrada_idEntrada` ) ,
  INDEX `fk_item_entrada_Produto1_idx` (`Produto_cod_Produto` ) ,
  CONSTRAINT `fk_item_entrada_Entrada1`
    FOREIGN KEY (`Entrada_idEntrada`)
    REFERENCES `autopecas_barcelos`.`Entrada` (`idEntrada`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_item_entrada_Produto1`
    FOREIGN KEY (`Produto_cod_Produto`)
    REFERENCES `autopecas_barcelos`.`Produto` (`cod_Produto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `autopecas_barcelos`.`Venda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autopecas_barcelos`.`Venda` (
  ...
  PRIMARY KEY (`idVenda`),
  INDEX `fk_Venda_cliente1_idx` (`cliente_cod_cliente` ) ,
  INDEX `fk_Venda_Funcionario1_idx` (`Funcionario_idFuncionario` ) ,
  ...
  CONSTRAINT `fk_Venda_Funcionario1`
    ...
    REFERENCES `autopecas_barcelos`.`Funcionario` (`idFuncionario`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `autopecas_barcelos`.`ItensVenda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `autopecas_barcelos`.`ItensVenda` (
  `idItensVenda` INT NOT NULL AUTO_INCREMENT,
  `quantidade_itens` INT NOT NULL,
  `Produto_cod_Produto` INT NOT NULL,
  `Venda_idVenda` INT NOT NULL,
  `preco_total_itens` VARCHAR(45) NOT NULL,
  PRIMARY KEY (`idItensVenda`),
  INDEX `fk_ItensVenda_Produto1_idx` (`Produto_cod_Produto` ) ,
  INDEX `fk_ItensVenda_Venda1_idx` (`Venda_idVenda` ) ,
  ...
  CONSTRAINT `fk_ItensVenda_Venda1`
    ...
    REFERENCES `autopecas_barcelos`.`Venda` (`idVenda`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
